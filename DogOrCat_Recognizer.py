...
#                 img.verify()
#                 #print('what:', type)
#                 if type not in image_exts:
#                     print('image not in image_exts {}' .format(image_path))
...
#test
#test_img = cv2.imread('Image Classifier/test imgs/cat.jpg')
...
#Image Classifier/test imgs/cat.jpg
